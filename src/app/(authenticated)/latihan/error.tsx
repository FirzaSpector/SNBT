...
export default function LatihanError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("Latihan error:", error);
  }, [error]);
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center p-6 text-center">
      ...
      <p className="text-text-secondary text-sm mb-6 max-w-sm">
        Maaf, terjadi kesalahan saat memuat halaman latihan. Soal kamu tetap tersimpan aman.
      </p>
      <div className="flex gap-3">
        <button
          ...
          aria-label="Coba muat ulang latihan"
        >
